...
- `/console`: Home dashboard. Work(Chat at `/console/chat` with dockable session health recommendations, Memory, System Prompt, Extensions), Operate(Agent Runtime, Approvals, Pulse, Reflection), Setup(Settings)
