	...
	cmd := &cobra.Command{
		...
		RunE: func(_ *cobra.Command, _ []string) error {
			...
			supervisor := sentinel.NewSupervisor(sentinel.Options{
				...
				ProbeStartGrace:         time.Duration(cfg.ProbeStartGraceMS) * time.Millisecond,
				...
				EventPersistenceEnabled: cfg.EventPersistenceEnabled,
				EventStorePath:          cfg.EventStorePath,
				EventStoreMaxRecords:    cfg.EventStoreMaxRecords,
