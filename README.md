...
- `/config` opens advanced per-session tool, skill, and automation consent controls when a selected session needs explicit overrides; permission changes show a deterministic risk/impact preview before saving
