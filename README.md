...
| Setup | Settings | `/console/config` | Workspace configuration with structured object/array editing, typed LLM tier editing, pending-change impact previews, and field metadata badges |
