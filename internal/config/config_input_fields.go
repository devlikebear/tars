...
var configInputFields = []configInputField{
	...
	// 3-tier router fields. See internal/config/llm_tiers.go and internal/llm/router.go.
	...
	// Heavy tier.
	llmTierStringField("llm_tier_heavy_provider", []string{"LLM_TIER_HEAVY_PROVIDER", "TARS_LLM_TIER_HEAVY_PROVIDER"}, tierHeavyAccessor, tierSpecProvider),
	llmTierStringField("llm_tier_heavy_auth_mode", []string{"LLM_TIER_HEAVY_AUTH_MODE", "TARS_LLM_TIER_HEAVY_AUTH_MODE"}, tierHeavyAccessor, tierSpecAuthMode),
	llmTierStringField("llm_tier_heavy_oauth_provider", []string{"LLM_TIER_HEAVY_OAUTH_PROVIDER", "TARS_LLM_TIER_HEAVY_OAUTH_PROVIDER"}, tierHeavyAccessor, tierSpecOAuthProvider),
	llmTierStringField("llm_tier_heavy_base_url", []string{"LLM_TIER_HEAVY_BASE_URL", "TARS_LLM_TIER_HEAVY_BASE_URL"}, tierHeavyAccessor, tierSpecBaseURL),
	llmTierStringField("llm_tier_heavy_api_key", []string{"LLM_TIER_HEAVY_API_KEY", "TARS_LLM_TIER_HEAVY_API_KEY"}, tierHeavyAccessor, tierSpecAPIKey),
	llmTierStringField("llm_tier_heavy_model", []string{"LLM_TIER_HEAVY_MODEL", "TARS_LLM_TIER_HEAVY_MODEL"}, tierHeavyAccessor, tierSpecModel),
	llmTierStringField("llm_tier_heavy_reasoning_effort", []string{"LLM_TIER_HEAVY_REASONING_EFFORT", "TARS_LLM_TIER_HEAVY_REASONING_EFFORT"}, tierHeavyAccessor, tierSpecReasoningEffort),
	llmTierIntField("llm_tier_heavy_thinking_budget", []string{"LLM_TIER_HEAVY_THINKING_BUDGET", "TARS_LLM_TIER_HEAVY_THINKING_BUDGET"}, tierHeavyAccessor, tierSpecThinkingBudget),
	llmTierStringField("llm_tier_heavy_service_tier", []string{"LLM_TIER_HEAVY_SERVICE_TIER", "TARS_LLM_TIER_HEAVY_SERVICE_TIER"}, tierHeavyAccessor, tierSpecServiceTier),
	// Standard tier.
	llmTierStringField("llm_tier_standard_provider", []string{"LLM_TIER_STANDARD_PROVIDER", "TARS_LLM_TIER_STANDARD_PROVIDER"}, tierStandardAccessor, tierSpecProvider),
	llmTierStringField("llm_tier_standard_auth_mode", []string{"LLM_TIER_STANDARD_AUTH_MODE", "TARS_LLM_TIER_STANDARD_AUTH_MODE"}, tierStandardAccessor, tierSpecAuthMode),
	llmTierStringField("llm_tier_standard_oauth_provider", []string{"LLM_TIER_STANDARD_OAUTH_PROVIDER", "TARS_LLM_TIER_STANDARD_OAUTH_PROVIDER"}, tierStandardAccessor, tierSpecOAuthProvider),
	llmTierStringField("llm_tier_standard_base_url", []string{"LLM_TIER_STANDARD_BASE_URL", "TARS_LLM_TIER_STANDARD_BASE_URL"}, tierStandardAccessor, tierSpecBaseURL),
	llmTierStringField("llm_tier_standard_api_key", []string{"LLM_TIER_STANDARD_API_KEY", "TARS_LLM_TIER_STANDARD_API_KEY"}, tierStandardAccessor, tierSpecAPIKey),
	llmTierStringField("llm_tier_standard_model", []string{"LLM_TIER_STANDARD_MODEL", "TARS_LLM_TIER_STANDARD_MODEL"}, tierStandardAccessor, tierSpecModel),
	llmTierStringField("llm_tier_standard_reasoning_effort", []string{"LLM_TIER_STANDARD_REASONING_EFFORT", "TARS_LLM_TIER_STANDARD_REASONING_EFFORT"}, tierStandardAccessor, tierSpecReasoningEffort),
	llmTierIntField("llm_tier_standard_thinking_budget", []string{"LLM_TIER_STANDARD_THINKING_BUDGET", "TARS_LLM_TIER_STANDARD_THINKING_BUDGET"}, tierStandardAccessor, tierSpecThinkingBudget),
	llmTierStringField("llm_tier_standard_service_tier", []string{"LLM_TIER_STANDARD_SERVICE_TIER", "TARS_LLM_TIER_STANDARD_SERVICE_TIER"}, tierStandardAccessor, tierSpecServiceTier),
	// Light tier.
	llmTierStringField("llm_tier_light_provider", []string{"LLM_TIER_LIGHT_PROVIDER", "TARS_LLM_TIER_LIGHT_PROVIDER"}, tierLightAccessor, tierSpecProvider),
	llmTierStringField("llm_tier_light_auth_mode", []string{"LLM_TIER_LIGHT_AUTH_MODE", "TARS_LLM_TIER_LIGHT_AUTH_MODE"}, tierLightAccessor, tierSpecAuthMode),
	llmTierStringField("llm_tier_light_oauth_provider", []string{"LLM_TIER_LIGHT_OAUTH_PROVIDER", "TARS_LLM_TIER_LIGHT_OAUTH_PROVIDER"}, tierLightAccessor, tierSpecOAuthProvider),
	llmTierStringField("llm_tier_light_base_url", []string{"LLM_TIER_LIGHT_BASE_URL", "TARS_LLM_TIER_LIGHT_BASE_URL"}, tierLightAccessor, tierSpecBaseURL),
	llmTierStringField("llm_tier_light_api_key", []string{"LLM_TIER_LIGHT_API_KEY", "TARS_LLM_TIER_LIGHT_API_KEY"}, tierLightAccessor, tierSpecAPIKey),
	llmTierStringField("llm_tier_light_model", []string{"LLM_TIER_LIGHT_MODEL", "TARS_LLM_TIER_LIGHT_MODEL"}, tierLightAccessor, tierSpecModel),
	llmTierStringField("llm_tier_light_reasoning_effort", []string{"LLM_TIER_LIGHT_REASONING_EFFORT", "TARS_LLM_TIER_LIGHT_REASONING_EFFORT"}, tierLightAccessor, tierSpecReasoningEffort),
	llmTierIntField("llm_tier_light_thinking_budget", []string{"LLM_TIER_LIGHT_THINKING_BUDGET", "TARS_LLM_TIER_LIGHT_THINKING_BUDGET"}, tierLightAccessor, tierSpecThinkingBudget),
	llmTierStringField("llm_tier_light_service_tier", []string{"LLM_TIER_LIGHT_SERVICE_TIER", "TARS_LLM_TIER_LIGHT_SERVICE_TIER"}, tierLightAccessor, tierSpecServiceTier),
	// Role → tier defaults. Empty value leaves the role unmapped (falls back to LLMDefaultTier).
	llmRoleField("llm_role_chat_main", RoleChatMain, []string{"LLM_ROLE_CHAT_MAIN", "TARS_LLM_ROLE_CHAT_MAIN"}),
	llmRoleField("llm_role_context_compactor", RoleContextCompactor, []string{"LLM_ROLE_CONTEXT_COMPACTOR", "TARS_LLM_ROLE_CONTEXT_COMPACTOR"}),
	llmRoleField("llm_role_memory_hook", RoleMemoryHook, []string{"LLM_ROLE_MEMORY_HOOK", "TARS_LLM_ROLE_MEMORY_HOOK"}),
	llmRoleField("llm_role_reflection_memory", RoleReflectionMemory, []string{"LLM_ROLE_REFLECTION_MEMORY", "TARS_LLM_ROLE_REFLECTION_MEMORY"}),
	llmRoleField("llm_role_reflection_kb", RoleReflectionKB, []string{"LLM_ROLE_REFLECTION_KB", "TARS_LLM_ROLE_REFLECTION_KB"}),
