...
var configInputFields = []configInputField{
	...
	stringField("bifrost_base_url", []string{"BIFROST_BASE_URL", "TARS_BIFROST_BASE_URL"}, func(cfg *Config) *string { return &cfg.BifrostBase }, identityString),
	stringField("bifrost_api_key", []string{"BIFROST_API_KEY", "TARS_BIFROST_API_KEY"}, func(cfg *Config) *string { return &cfg.BifrostAPIKey }, identityString),
	stringField("bifrost_model", []string{"BIFROST_MODEL", "TARS_BIFROST_MODEL"}, func(cfg *Config) *string { return &cfg.BifrostModel }, identityString),
	...
	boolField("browser_relay_enabled", []string{"BROWSER_RELAY_ENABLED", "TARS_BROWSER_RELAY_ENABLED"}, func(cfg *Config) *bool { return &cfg.BrowserRelayEnabled }),
	stringField("browser_relay_addr", []string{"BROWSER_RELAY_ADDR", "TARS_BROWSER_RELAY_ADDR"}, func(cfg *Config) *string { return &cfg.BrowserRelayAddr }, strings.TrimSpace),
	stringField("browser_relay_token", []string{"BROWSER_RELAY_TOKEN", "TARS_BROWSER_RELAY_TOKEN"}, func(cfg *Config) *string { return &cfg.BrowserRelayToken }, strings.TrimSpace),
	boolField("browser_relay_allow_query_token", []string{"BROWSER_RELAY_ALLOW_QUERY_TOKEN", "TARS_BROWSER_RELAY_ALLOW_QUERY_TOKEN"}, func(cfg *Config) *bool { return &cfg.BrowserRelayAllowQueryToken }),
	stringListField("browser_relay_origin_allowlist_json", []string{"BROWSER_RELAY_ORIGIN_ALLOWLIST_JSON", "TARS_BROWSER_RELAY_ORIGIN_ALLOWLIST_JSON"}, func(cfg *Config) *[]string { return &cfg.BrowserRelayOriginAllowlist }, parseJSONStringList),
