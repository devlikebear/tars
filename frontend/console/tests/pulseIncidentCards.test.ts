...
test('Pulse page renders incident cards with safe actions', () => {
  assert.match(pulseSource, /Incident cards/)
  assert.match(pulseSource, /buildPulseIncidentCards/)
  assert.match(pulseSource, /pulse-incident-card/)
  assert.match(pulseSource, /Likely cause/)
  assert.match(pulseSource, /Evidence/)
  assert.match(pulseSource, /Recommended action/)
  assert.match(pulseSource, /Open affected page/)
  assert.match(pulseSource, /Re-check/)
})
