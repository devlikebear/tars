...
TARS는 2개의 Go 바이너리로 구성된 경량 로컬 AI 자동화 스택입니다.

- `tarsd`: 데몬/서버 (LLM 오케스트레이션, 세션, 도구, 게이트웨이, 자동화)
- `tars`: 터미널 클라이언트 (Bubble Tea 3패널 TUI)
